...
pub fn router(state: SharedState) -> Router {
    Router::new()
        ...
        .route("/styles/foundation.css", get(ui::foundation_css))
        .route("/styles/theme.css", get(ui::theme_css))
        .route("/styles/players.css", get(ui::players_css))
        .route("/styles/leaderboard.css", get(ui::leaderboard_css))
